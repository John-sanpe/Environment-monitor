      ...
      00034C 7F 0F            [12]  414 	mov	r7,#0x0f
                                    415 ;	./src/dht11.c:10: while (--i);
      00034E                        416 00101$:
      00034E EF               [12]  417 	mov	a,r7
      00034F 14               [12]  418 	dec	a
      000350 FF               [12]  419 	mov	r7,a
      000351 70 FB            [24]  420 	jnz	00101$
                                    421 ;	./src/dht11.c:11: }
      000353 22               [24]  422 	ret
                                    423 ;------------------------------------------------------------
                                    ...
                                    429 ;	-----------------------------------------
      000354                        430 _DHT11_Start:
                                    431 ;	./src/dht11.c:14: DHT11=0;
                                    432 ;	assignBit
      000354 C2 A4            [12]  433 	clr	_P2_4
                                    434 ;	./src/dht11.c:15: delayms(20);
      000356 90 00 14         [24]  435 	mov	dptr,#0x0014
      000359 12 02 FE         [24]  436 	lcall	_delayms
                                    437 ;	./src/dht11.c:16: DHT11=1;
                                    438 ;	assignBit
      00035C D2 A4            [12]  439 	setb	_P2_4
                                    440 ;	./src/dht11.c:17: DHTStartDelay();
      00035E 12 03 4C         [24]  441 	lcall	_DHTStartDelay
                                    442 ;	./src/dht11.c:18: while(!DHT11);
      000361                        443 00101$:
      000361 30 A4 FD         [24]  444 	jnb	_P2_4,00101$
                                    445 ;	./src/dht11.c:19: while(DHT11);
      000364                        446 00104$:
      000364 20 A4 FD         [24]  447 	jb	_P2_4,00104$
                                    448 ;	./src/dht11.c:20: }
      000367 22               [24]  449 	ret
                                    450 ;------------------------------------------------------------
                                    ...
                                    458 ;	-----------------------------------------
      000368                        459 _DHT11_Data:
                                    460 ;	./src/dht11.c:24: for(temp=0;temp<32;temp++)
      000368 7F 00            [12]  461 	mov	r7,#0x00
      00036A                        462 00119$:
                                    463 ;	./src/dht11.c:26: TL0=0;
      00036A 75 8A 00         [24]  464 	mov	_TL0,#0x00
                                    465 ;	./src/dht11.c:27: while(!DHT11);
      00036D                        466 00101$:
      00036D 30 A4 FD         [24]  467 	jnb	_P2_4,00101$
                                    468 ;	./src/dht11.c:28: TR0=1;
                                    469 ;	assignBit
      000370 D2 8C            [12]  470 	setb	_TR0
                                    471 ;	./src/dht11.c:29: while(DHT11);
      000372                        472 00104$:
      000372 20 A4 FD         [24]  473 	jb	_P2_4,00104$
                                    474 ;	./src/dht11.c:30: TR0=0;
                                    475 ;	assignBit
      000375 C2 8C            [12]  476 	clr	_TR0
                                    477 ;	./src/dht11.c:31: mixdata<<=1;
      000377 E5 1C            [12]  478 	mov	a,_mixdata
      000379 25 1C            [12]  479 	add	a,_mixdata
      00037B F5 1C            [12]  480 	mov	_mixdata,a
      00037D E5 1D            [12]  481 	mov	a,(_mixdata + 1)
      00037F 33               [12]  482 	rlc	a
      000380 F5 1D            [12]  483 	mov	(_mixdata + 1),a
      000382 E5 1E            [12]  484 	mov	a,(_mixdata + 2)
      000384 33               [12]  485 	rlc	a
      000385 F5 1E            [12]  486 	mov	(_mixdata + 2),a
      000387 E5 1F            [12]  487 	mov	a,(_mixdata + 3)
      000389 33               [12]  488 	rlc	a
      00038A F5 1F            [12]  489 	mov	(_mixdata + 3),a
                                    490 ;	./src/dht11.c:32: if(TL0>dht11_threshold)mixdata|=1;
      00038C E5 8A            [12]  491 	mov	a,_TL0
      00038E 24 CD            [12]  492 	add	a,#0xff - 0x32
      000390 50 03            [24]  493 	jnc	00120$
      000392 43 1C 01         [24]  494 	orl	_mixdata,#0x01
      000395                        495 00120$:
                                    496 ;	./src/dht11.c:24: for(temp=0;temp<32;temp++)
      000395 0F               [12]  497 	inc	r7
      000396 BF 20 00         [24]  498 	cjne	r7,#0x20,00182$
      000399                        499 00182$:
      000399 40 CF            [24]  500 	jc	00119$
                                    501 ;	./src/dht11.c:34: for(temp=0;temp<8;temp++)
      00039B 7F 00            [12]  502 	mov	r7,#0x00
      00039D                        503 00121$:
                                    504 ;	./src/dht11.c:36: TL0=0;
      00039D 75 8A 00         [24]  505 	mov	_TL0,#0x00
                                    506 ;	./src/dht11.c:37: while(!DHT11);
      0003A0                        507 00110$:
      0003A0 30 A4 FD         [24]  508 	jnb	_P2_4,00110$
                                    509 ;	./src/dht11.c:38: TR0=1;
                                    510 ;	assignBit
      0003A3 D2 8C            [12]  511 	setb	_TR0
                                    512 ;	./src/dht11.c:39: while(DHT11);
      0003A5                        513 00113$:
      0003A5 20 A4 FD         [24]  514 	jb	_P2_4,00113$
                                    515 ;	./src/dht11.c:40: TR0=0;
                                    516 ;	assignBit
      0003A8 C2 8C            [12]  517 	clr	_TR0
                                    518 ;	./src/dht11.c:41: check<<=1;
      0003AA E5 28            [12]  519 	mov	a,_check
      0003AC 25 28            [12]  520 	add	a,_check
      0003AE F5 28            [12]  521 	mov	_check,a
      0003B0 E5 29            [12]  522 	mov	a,(_check + 1)
      0003B2 33               [12]  523 	rlc	a
      0003B3 F5 29            [12]  524 	mov	(_check + 1),a
                                    525 ;	./src/dht11.c:42: if(TL0>dht11_threshold)check|=1;
      0003B5 E5 8A            [12]  526 	mov	a,_TL0
      0003B7 24 CD            [12]  527 	add	a,#0xff - 0x32
      0003B9 50 03            [24]  528 	jnc	00122$
      0003BB 43 28 01         [24]  529 	orl	_check,#0x01
      0003BE                        530 00122$:
                                    531 ;	./src/dht11.c:34: for(temp=0;temp<8;temp++)
      0003BE 0F               [12]  532 	inc	r7
      0003BF BF 08 00         [24]  533 	cjne	r7,#0x08,00187$
      0003C2                        534 00187$:
      0003C2 40 D9            [24]  535 	jc	00121$
                                    536 ;	./src/dht11.c:44: }
      0003C4 22               [24]  537 	ret
                                    538 ;------------------------------------------------------------
                                    539 ;Allocation info for local variables in function 'DHT11_Read'
                                    540 ;------------------------------------------------------------
                                    541 ;	./src/dht11.c:46: char DHT11_Read(void)
                                    542 ;	-----------------------------------------
                                    543 ;	 function DHT11_Read
                                    544 ;	-----------------------------------------
      0003C5                        545 _DHT11_Read:
                                    546 ;	./src/dht11.c:49: mixdata=0;
      0003C5 E4               [12]  547 	clr	a
      0003C6 F5 1C            [12]  548 	mov	_mixdata,a
      0003C8 F5 1D            [12]  549 	mov	(_mixdata + 1),a
      0003CA F5 1E            [12]  550 	mov	(_mixdata + 2),a
      0003CC F5 1F            [12]  551 	mov	(_mixdata + 3),a
                                    552 ;	./src/dht11.c:50: check=0;
      0003CE F5 28            [12]  553 	mov	_check,a
      0003D0 F5 29            [12]  554 	mov	(_check + 1),a
                                    555 ;	./src/dht11.c:52: DHT11_Start();
      0003D2 12 03 54         [24]  556 	lcall	_DHT11_Start
                                    557 ;	./src/dht11.c:53: DHT11_Data();
      0003D5 12 03 68         [24]  558 	lcall	_DHT11_Data
                                    559 ;	./src/dht11.c:55: hum=(mixdata>>24)&0xff;
      0003D8 AF 1F            [24]  560 	mov	r7,(_mixdata + 3)
      0003DA 8F 20            [24]  561 	mov	_hum,r7
      0003DC 75 21 00         [24]  562 	mov	(_hum + 1),#0x00
                                    563 ;	./src/dht11.c:56: the=(mixdata>>8)&0xff;
      0003DF AE 1D            [24]  564 	mov	r6,(_mixdata + 1)
      0003E1 8E 22            [24]  565 	mov	_the,r6
      0003E3 75 23 00         [24]  566 	mov	(_the + 1),#0x00
                                    567 ;	./src/dht11.c:57: thef=(mixdata>>0)&0xf;
      0003E6 AE 1C            [24]  568 	mov	r6,_mixdata
      0003E8 74 0F            [12]  569 	mov	a,#0x0f
      0003EA 5E               [12]  570 	anl	a,r6
      0003EB F5 24            [12]  571 	mov	_thef,a
      0003ED 75 25 00         [24]  572 	mov	(_thef + 1),#0x00
                                    573 ;	./src/dht11.c:59: subzero=(mixdata>>7)&0x1;
      0003F0 E5 1C            [12]  574 	mov	a,_mixdata
      0003F2 23               [12]  575 	rl	a
      0003F3 54 01            [12]  576 	anl	a,#0x01
      0003F5 FF               [12]  577 	mov	r7,a
      0003F6 8F 26            [24]  578 	mov	_subzero,r7
      0003F8 75 27 00         [24]  579 	mov	(_subzero + 1),#0x00
                                    580 ;	./src/dht11.c:61: if(check!=hum+the+thef)return -1;
      0003FB E5 22            [12]  581 	mov	a,_the
      0003FD 25 20            [12]  582 	add	a,_hum
      0003FF FE               [12]  583 	mov	r6,a
      000400 E5 23            [12]  584 	mov	a,(_the + 1)
      000402 35 21            [12]  585 	addc	a,(_hum + 1)
      000404 FF               [12]  586 	mov	r7,a
      000405 E5 24            [12]  587 	mov	a,_thef
      000407 2E               [12]  588 	add	a,r6
      000408 FE               [12]  589 	mov	r6,a
      000409 E5 25            [12]  590 	mov	a,(_thef + 1)
      00040B 3F               [12]  591 	addc	a,r7
      00040C FF               [12]  592 	mov	r7,a
      00040D EE               [12]  593 	mov	a,r6
      00040E B5 28 06         [24]  594 	cjne	a,_check,00109$
      000411 EF               [12]  595 	mov	a,r7
      000412 B5 29 02         [24]  596 	cjne	a,(_check + 1),00109$
      000415 80 04            [24]  597 	sjmp	00102$
      000417                        598 00109$:
      000417 75 82 FF         [24]  599 	mov	dpl,#0xff
      00041A 22               [24]  600 	ret
      00041B                        601 00102$:
                                    602 ;	./src/dht11.c:62: return 0;
      00041B 75 82 00         [24]  603 	mov	dpl,#0x00
                                    604 ;	./src/dht11.c:63: }
      00041E 22               [24]  605 	ret
                                    606 	.area CSEG    (CODE)
                                    607 	.area CONST   (CODE)
                                    608 	.area XINIT   (CODE)
