      ...
      0005E0 43 E1 20         [24]  391 	orl	_WDT_CONTR,#0x20
                                    392 ;	./src/wdt.c:6: WDT_CONTR|=0x07<<0;
      0005E3 43 E1 07         [24]  393 	orl	_WDT_CONTR,#0x07
                                    394 ;	./src/wdt.c:8: }
      0005E6 22               [24]  395 	ret
                                    396 ;------------------------------------------------------------
                                    ...
                                    404 ;	-----------------------------------------
      0005E7                        405 _Wdt_Runsign:
                                    406 ;	./src/wdt.c:12: sign=(PCON>>4)&0x01;
      0005E7 E5 87            [12]  407 	mov	a,_PCON
      0005E9 C4               [12]  408 	swap	a
      0005EA 54 01            [12]  409 	anl	a,#0x01
      0005EC F5 82            [12]  410 	mov	dpl,a
                                    411 ;	./src/wdt.c:13: PCON&=~(1<<4);
      0005EE 53 87 EF         [24]  412 	anl	_PCON,#0xef
                                    413 ;	./src/wdt.c:14: return sign;
                                    414 ;	./src/wdt.c:15: }
      0005F1 22               [24]  415 	ret
                                    416 ;------------------------------------------------------------
                                    ...
                                    422 ;	-----------------------------------------
      0005F2                        423 _Wdt_Clean:
                                    424 ;	./src/wdt.c:18: WDT_CONTR|=0x01<<4;
      0005F2 43 E1 10         [24]  425 	orl	_WDT_CONTR,#0x10
                                    426 ;	./src/wdt.c:19: }
      0005F5 22               [24]  427 	ret
                                    428 	.area CSEG    (CODE)
                                    429 	.area CONST   (CODE)
                                    430 	.area XINIT   (CODE)
