      ...
      0002FE                        388 _delayms:
                           ...
                           000001   395 	ar1 = 0x01
                           000000   396 	ar0 = 0x00
      0002FE AE 82            [24]  397 	mov	r6,dpl
      000300 AF 83            [24]  398 	mov	r7,dph
                                    399 ;	./src/control.c:6: TL2 = 0x30;		
      000302 75 CC 30         [24]  400 	mov	_TL2,#0x30
                                    401 ;	./src/control.c:7: TH2 = 0xF8;
      000305 75 CD F8         [24]  402 	mov	_TH2,#0xf8
                                    403 ;	./src/control.c:8: tm=ms;
      000308 8E 1A            [24]  404 	mov	_tm,r6
      00030A 8F 1B            [24]  405 	mov	(_tm + 1),r7
                                    406 ;	./src/control.c:9: TR2=1;
                                    407 ;	assignBit
      00030C D2 CA            [12]  408 	setb	_TR2
                                    409 ;	./src/control.c:10: while(!(tm==0))idle();
      00030E                        410 00101$:
      00030E E5 1A            [12]  411 	mov	a,_tm
      000310 45 1B            [12]  412 	orl	a,(_tm + 1)
      000312 60 05            [24]  413 	jz	00103$
      000314 12 03 23         [24]  414 	lcall	_idle
      000317 80 F5            [24]  415 	sjmp	00101$
      000319                        416 00103$:
                                    417 ;	./src/control.c:11: TR2=0;
                                    418 ;	assignBit
      000319 C2 CA            [12]  419 	clr	_TR2
                                    420 ;	./src/control.c:13: }
      00031B 22               [24]  421 	ret
                                    422 ;------------------------------------------------------------
                                    ...
                                    428 ;	-----------------------------------------
      00031C                        429 _Int_Init:
                                    430 ;	./src/control.c:17: EA=1;
                                    431 ;	assignBit
      00031C D2 AF            [12]  432 	setb	_EA
                                    433 ;	./src/control.c:18: ET2=1;
                                    434 ;	assignBit
      00031E D2 AD            [12]  435 	setb	_ET2
                                    436 ;	./src/control.c:19: ES=1;
                                    437 ;	assignBit
      000320 D2 AC            [12]  438 	setb	_ES
                                    439 ;	./src/control.c:20: }
      000322 22               [24]  440 	ret
                                    441 ;------------------------------------------------------------
      ...
      000323 43 87 01         [24]  450 	orl	_PCON,#0x01
                                    451 ;	./src/control.c:25: }
      000326 22               [24]  452 	ret
                                    453 ;------------------------------------------------------------
                                    ...
                                    459 ;	-----------------------------------------
      000327                        460 _Time0_Init:
                                    461 ;	./src/control.c:29: TMOD|= 0x02;
      000327 43 89 02         [24]  462 	orl	_TMOD,#0x02
                                    463 ;	./src/control.c:30: }
      00032A 22               [24]  464 	ret
                                    465 ;------------------------------------------------------------
                                    ...
                                    471 ;	-----------------------------------------
      00032B                        472 _Time2_Init:
                                    473 ;	./src/control.c:33: RCAP2L = 0x30;
      00032B 75 CA 30         [24]  474 	mov	_RCAP2L,#0x30
                                    475 ;	./src/control.c:34: RCAP2H = 0xF8;
      00032E 75 CB F8         [24]  476 	mov	_RCAP2H,#0xf8
                                    477 ;	./src/control.c:35: TL2 = 0x30;		
      000331 75 CC 30         [24]  478 	mov	_TL2,#0x30
                                    479 ;	./src/control.c:36: TH2 = 0xF8;
      000334 75 CD F8         [24]  480 	mov	_TH2,#0xf8
                                    481 ;	./src/control.c:37: }
      000337 22               [24]  482 	ret
                                    483 ;------------------------------------------------------------
                                    ...
                                    489 ;	-----------------------------------------
      000338                        490 _delayserver:
      000338 C0 E0            [24]  491 	push	acc
      00033A C0 D0            [24]  492 	push	psw
                                    493 ;	./src/control.c:41: tm--;
      00033C 15 1A            [12]  494 	dec	_tm
      00033E 74 FF            [12]  495 	mov	a,#0xff
      000340 B5 1A 02         [24]  496 	cjne	a,_tm,00103$
      000343 15 1B            [12]  497 	dec	(_tm + 1)
      000345                        498 00103$:
                                    499 ;	./src/control.c:42: TF2=0;
                                    500 ;	assignBit
      000345 C2 CF            [12]  501 	clr	_TF2
                                    502 ;	./src/control.c:43: }
      000347 D0 D0            [24]  503 	pop	psw
      000349 D0 E0            [24]  504 	pop	acc
      00034B 32               [24]  505 	reti
