      ...
      0005A5 43 89 20         [24]  392 	orl	_TMOD,#0x20
                                    393 ;	./src/serial.c:5: TL1 = 243;		//设定定时初值
      0005A8 75 8B F3         [24]  394 	mov	_TL1,#0xf3
                                    395 ;	./src/serial.c:6: TH1 = 243;		//设定定时器重装值
      0005AB 75 8D F3         [24]  396 	mov	_TH1,#0xf3
                                    397 ;	./src/serial.c:7: TR1 = 1;		//启动定时器1
                                    398 ;	assignBit
      0005AE D2 8E            [12]  399 	setb	_TR1
                                    400 ;	./src/serial.c:8: }
      0005B0 22               [24]  401 	ret
                                    402 ;------------------------------------------------------------
                                    ...
                                    408 ;	-----------------------------------------
      0005B1                        409 _Serial_Init:
                                    410 ;	./src/serial.c:11: SM0=0;
                                    411 ;	assignBit
      0005B1 C2 9F            [12]  412 	clr	_SM0
                                    413 ;	./src/serial.c:12: SM1=1;
                                    414 ;	assignBit
      0005B3 D2 9E            [12]  415 	setb	_SM1
                                    416 ;	./src/serial.c:13: REN=1;
                                    417 ;	assignBit
      0005B5 D2 9C            [12]  418 	setb	_REN
                                    419 ;	./src/serial.c:14: PCON|=1<<7;
      0005B7 43 87 80         [24]  420 	orl	_PCON,#0x80
                                    421 ;	./src/serial.c:15: }
      0005BA 22               [24]  422 	ret
                                    423 ;------------------------------------------------------------
                                    ...
                                    431 ;	-----------------------------------------
      0005BB                        432 _putchar:
      0005BB AE 82            [24]  433 	mov	r6,dpl
      0005BD AF 83            [24]  434 	mov	r7,dph
                                    435 ;	./src/serial.c:18: SBUF=string;
      0005BF 8E 99            [24]  436 	mov	_SBUF,r6
                                    437 ;	./src/serial.c:19: idle();
      0005C1 C0 07            [24]  438 	push	ar7
      0005C3 C0 06            [24]  439 	push	ar6
      0005C5 12 03 23         [24]  440 	lcall	_idle
      0005C8 D0 06            [24]  441 	pop	ar6
      0005CA D0 07            [24]  442 	pop	ar7
                                    443 ;	./src/serial.c:20: return string;
      0005CC 8E 82            [24]  444 	mov	dpl,r6
      0005CE 8F 83            [24]  445 	mov	dph,r7
                                    446 ;	./src/serial.c:21: }
      0005D0 22               [24]  447 	ret
                                    448 ;------------------------------------------------------------
                                    ...
                                    454 ;	-----------------------------------------
      0005D1                        455 _Serial_Handel:
                                    456 ;	./src/serial.c:25: EA=0;
                                    457 ;	assignBit
      0005D1 C2 AF            [12]  458 	clr	_EA
                                    459 ;	./src/serial.c:26: if(TI==1)
                                    460 ;	./src/serial.c:28: TI=0;
                                    461 ;	assignBit
      0005D3 10 99 02         [24]  462 	jbc	_TI,00115$
      0005D6 80 00            [24]  463 	sjmp	00102$
      0005D8                        464 00115$:
      0005D8                        465 00102$:
                                    466 ;	./src/serial.c:30: if(RI==1)
                                    467 ;	./src/serial.c:32: RI=0;
                                    468 ;	assignBit
      0005D8 10 98 02         [24]  469 	jbc	_RI,00116$
      0005DB 80 00            [24]  470 	sjmp	00104$
      0005DD                        471 00116$:
      0005DD                        472 00104$:
                                    473 ;	./src/serial.c:34: EA=1;
                                    474 ;	assignBit
      0005DD D2 AF            [12]  475 	setb	_EA
                                    476 ;	./src/serial.c:35: }
      0005DF 32               [24]  477 	reti
