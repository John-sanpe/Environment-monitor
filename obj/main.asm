...
;	./src/main.c:71: Time2_Init();		//初始化定时器2
	lcall	_Time2_Init
;	./src/main.c:72: Lcd1602_Init();		//初始化lcd1602
	lcall	_Lcd1602_Init
;	./src/main.c:73: Lcd1602_Clean();	//清空lcd1602显存
	lcall	_Lcd1602_Clean
;	./src/main.c:74: print_boot();		//显示欢迎界面(等待DHT11初始化完成)
	lcall	_print_boot
;	./src/main.c:75: Boot_Test();		//开机自检
	lcall	_Boot_Test
;	./src/main.c:76: while(1){
00104$:
;	./src/main.c:77: Wdt_Clean();
	lcall	_Wdt_Clean
;	./src/main.c:78: if(0==DHT11_Read())
	lcall	_DHT11_Read
	mov	a,dpl
	jnz	00102$
;	./src/main.c:80: Lcd1602_Init();
	lcall	_Lcd1602_Init
;	./src/main.c:81: Lcd1602_Clean();	
	lcall	_Lcd1602_Clean
;	./src/main.c:82: show_base();
	lcall	_show_base
;	./src/main.c:83: show_data();
	lcall	_show_data
;	./src/main.c:84: show_info();
	lcall	_show_info
00102$:
;	./src/main.c:86: show_time();
	lcall	_show_time
;	./src/main.c:87: debug();
	lcall	_debug
;	./src/main.c:88: delayms(1500);
	mov	dptr,#0x05dc
	lcall	_delayms
;	./src/main.c:90: } 
	sjmp	00104$
