      ...
      00041F                        381 _E2prom_Read:
                           ...
                           000001   388 	ar1 = 0x01
                           000000   389 	ar0 = 0x00
      00041F AE 82            [24]  390 	mov	r6,dpl
      000421 AF 83            [24]  391 	mov	r7,dph
                                    392 ;	./src/e2prom.c:9: ISP_CMD=Cmd_Read;
      000423 75 E5 01         [24]  393 	mov	_ISP_CMD,#0x01
                                    394 ;	./src/e2prom.c:10: ISP_ADDRH=(add>>8)&0xff;
      000426 8F E3            [24]  395 	mov	_ISP_ADDRH,r7
                                    396 ;	./src/e2prom.c:11: ISP_ADDRL=(add>>0)&0xff;
      000428 8E E4            [24]  397 	mov	_ISP_ADDRL,r6
                                    398 ;	./src/e2prom.c:12: return 0;
      00042A 75 82 00         [24]  399 	mov	dpl,#0x00
                                    400 ;	./src/e2prom.c:13: }
      00042D 22               [24]  401 	ret
                                    402 	.area CSEG    (CODE)
                                    403 	.area CONST   (CODE)
                                    404 	.area XINIT   (CODE)
